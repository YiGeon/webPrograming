...
const callbackURL = (process.env.NODE_ENV == 'production')?
  'https://vast-headland-82597.herokuapp.com/auth/facebook/callback' :
  'http://localhost:3000/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '1893032107692559',
    clientSecret : process.env.FB_SECRET || '488dcbba17f52935832d03f01b8d7280',
